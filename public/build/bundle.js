...
var app = (function () {
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*items*/ 1) carouselitem_changes.title = /*item*/ ctx[1].title;
    			if (dirty & /*items*/ 1) carouselitem_changes.status = /*item*/ ctx[1].status;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(23:4) {#each items as item (item.id)}",
    		ctx
    	});
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ onMount, tns, CarouselItem, items });
    ...
    class Carousel extends SvelteComponentDev {
    	constructor(options) {
    		...
    		if (/*items*/ ctx[0] === undefined && !("items" in props)) {
    			console.warn("<Carousel> was created without expected prop 'items'");
    		}
    	}
